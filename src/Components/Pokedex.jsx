...
//         <input type="text" {...register( 'pokemonName' )} placeholder='Search a Pokemon'/>
...
//       <select onChange={typesFilter}>
//         <option value={ 'https://pokeapi.co/api/v2/pokemon?offset=0&limit=50'    
//           }>All Pokemons</option>
//         {
//           types.map(type => (
//             <option  key={type.url}
...
//   axios.get( e.target.value )
//   .then( res => setPokemonFiltered(res.data.pokemon))
...
//        <CharacterItems url={item.pokemon.url}/>
//      </li>
//       )
//  :
//  characters.map( item => 
//    <li key={item.name}>
//      <CharacterItems url={item.url}/>
//    </li>
//     )
// }